import 'package:bloc_demo_project/core/utils/app_extension.dart';
...
class ProductList {
  ...
  ProductList.fromJson(Map<String, dynamic> json) {
    ...
    slug = json['slug'].toString().toStringConversion();
    ...
    images =
        json['images'] != null && json['images'] is List
            ...
            : null;
    creationAt = json['creationAt'].toString().toStringConversion();
